...
public Medicine(String picture, double inPrice, double salPrice, String name, Integer type, String descs,
...
public Medicine(String mid, String picture, double inPrice, double salPrice, String name, Integer type, String descs,
		int qualityDate, String description, String produceFirm, String readme, String remark) {
	super();
	this.mid = mid;
	this.picture = picture;
