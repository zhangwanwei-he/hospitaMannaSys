...
<input name="method" value="updateByRegist" type="hidden">
...
<table class="table table-bordered table-hover definewidth m10">
    ...
    <tr>
        ...
        <td><input type="radio" name="sex" value="0"<c:if test="${register.sex==0 }">checked="checked"</c:if> />男&nbsp;&nbsp;&nbsp;
            <input type="radio" name="sex" value="1"<c:if test="${register.sex==0 }">checked="checked"</c:if>/>女</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
            ...
            <input type="radio" name="consultation" value="1" <c:if test="${register.consultation==0 }">checked="checked"</c:if>/>复诊
         </td>
    </tr>
    <tr>
        ...
        <td>
        	<select name="department" id="department">
        		<option value="1" <c:if test="${register.consultation==1}">checked="checked"</c:if>>急诊科</option>
        		<option value="2" <c:if test="${register.consultation==2 }">checked="checked"</c:if>>儿科</option>
        		<option value="3" <c:if test="${register.consultation==3 }">checked="checked"</c:if>>妇科</option>
        		<option value="4" <c:if test="${register.consultation==4 }">checked="checked"</c:if>>皮肤科</option>
        		<option value="5" <c:if test="${register.consultation==5 }">checked="checked"</c:if>>内分泌科</option>
        		<option value="6" <c:if test="${register.consultation==6 }">checked="checked"</c:if>>牙科</option>	
        	</select>
        </td>
    </tr>
    <tr>
        ...
        <td>
	        ...
	        <option value="${register.did}">${register.doctor.name}</option>
	        </select>
	     </td>  
    </tr>
	<tr>
        <td width="10%" class="tableleft">备注</td>
        <td><textarea name="remark" value="${register.remark }"></textarea></td>
	</tr>
    <tr>
        <td colspan="2">
			<center>
