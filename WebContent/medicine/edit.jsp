...
<body>
<form action="${path }medicine?method=updateMedicine" method="post" class="definewidth m20" enctype="multipart/form-data">
...
<table class="table table-bordered table-hover definewidth m10">
    ...
    <tr>
        ...
        <img  width="80px" height="50px" src="${imgPath}${me.picture}">
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
        	<input type="radio" name="type" value="1"  <c:if test="${me.type==1}">checked="checked"</c:if> />处方药&nbsp;&nbsp;&nbsp;
        	<input type="radio" name="type" value="2"  <c:if test="${me.type==2}">checked="checked"</c:if> />中药&nbsp;&nbsp;&nbsp;
        	<input type="radio" name="type" value="3"   <c:if test="${me.type==3}">checked="checked"</c:if>/>西药
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><textarea name="description" value="${me.description}"></textarea></td>
    </tr>
    <tr>
        <td width="10%" class="tableleft">生产厂商</td>
        <td><textarea name="produceFirm" value="${me.produceFirm}"></textarea></td>
    </tr>
    <tr>
	...
	<tr>
        ...
        <td><textarea name="remark" value="${me.remark}"></textarea></td>
	</tr>
    <tr>
        <td colspan="2">
			<center>
