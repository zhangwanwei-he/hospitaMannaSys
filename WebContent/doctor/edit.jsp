...
<table class="table table-bordered table-hover definewidth m10">
    ...
    <tr>
        ...
        <td>
        	<input type="radio" name="sex" value="1" <c:if test="${doctor.sex==1}">checked="checked"</c:if> />男&nbsp;&nbsp;&nbsp;
        	<input type="radio" name="sex"  value="0" <c:if test="${doctor.sex==0}">checked="checked"</c:if>/>女
        </td>
    </tr>
    <tr>
